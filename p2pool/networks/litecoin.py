...
PERSIST = True
WORKER_PORT = 9327
BOOTSTRAP_ADDRS = 'pool.ikolu.ca:9338'.split(' ')
...
USE_PUSHOVER_BLOCK = False
USE_PUSHOVER_SHARE = False
PUSHOVER_APP_TOKEN = 'USE YOUR APP TOKEN'
PUSHOVER_USER_KEY = 'USE YOUR USER KEY'
